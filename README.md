# CogniRank   ![Stars](https://img.shields.io/github/stars/【panpingxue-pinkney/CogniRank-Official】) ![License](https://img.shields.io/badge/License-BUSL--1.1-blue)


> An open-source AI project that automatically assesses the cognitive depth and thinking level of questioners (currently in early development)

## ⚠️ Important License Upgrade Notice (Effective November 20, 2025)

To ensure the project attracts excellent contributors while guaranteeing sustainable development and the deserved rewards for the original author,

this repository will officially adopt the **Business Source License 1.1 (BUSL-1.1)** effective immediately:

- **For the next 4 years (until December 1, 2029)**: Completely free to use, modify, distribute, and even commercially (even more lenient than MIT!)

- **After December 1, 2029**: Automatically converted to GPL; commercial use or SaaS development requires purchasing a commercial license.

- All future commercial revenue will be allocated **20%** as a "Contributor Bonus Pool" to reward active contributors.

The old repository is archived: https://github.com/panpingxue-pinkney/CogniRank The official mainline has been permanently migrated to this repository.

We warmly welcome all enthusiasts to participate in the development.
